...
class ThumbnailCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        data = UserDefaults.standard.array(forKey: key) as? [PKDrawing]
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let drawing = data?.first?.image(from:CGRect(x: 0, y: 0, width: 200, height: 200), scale: 1.0) else { return UICollectionViewCell() }
